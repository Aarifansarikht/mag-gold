...
import { PRODUCTS, SERVICES, STEEL_SYSTEMS } from '../constants';
import { GlassCard } from '../components/GlassCard';
import { Button } from '../components/Button';
import { LayoutGrid, Building2, ChevronRight, Droplets, TowerControl, Layers, ShieldCheck } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex justify-start space-x-6 mb-24 border-b border-white/5 pb-8">
          <button 
            ...
            className={`group relative px-12 py-5 rounded-full text-[11px] font-black uppercase tracking-[0.3em] transition-all duration-700 overflow-hidden ${
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'drainage' ? (
            ...
            >
              {/* Specialized Steel Grid with full list */}
